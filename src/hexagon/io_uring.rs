...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct zcrx_notif_stats {
pub copy_count: __u64,
pub copy_bytes: __u64,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct zcrx_notification_desc {
pub user_data: __u64,
pub type_mask: __u32,
pub flags: __u32,
pub stats_offset: __u64,
pub __resv2: [__u64; 9usize],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct zcrx_ctrl_arm_notif {
pub notif_type: __u32,
pub __resv: [__u32; 11usize],
}
#[repr(C)]
#[derive(Copy, Clone)]
...
pub nr_res: __u16,
pub resv: [__u32; 3usize],
pub __bindgen_anon_1: io_uring_task_restriction__bindgen_ty_1,
}
#[repr(C)]
pub struct io_uring_task_restriction__bindgen_ty_1 {
pub __empty_restrictions: io_uring_task_restriction__bindgen_ty_1__bindgen_ty_1,
pub restrictions: __IncompleteArrayField<io_uring_restriction>,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct io_uring_task_restriction__bindgen_ty_1__bindgen_ty_1 {}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const FS_XFLAG_CASEFOLD: u32 = 262144;
pub const FS_XFLAG_CASENONPRESERVING: u32 = 524288;
...
pub const IORING_SETUP_SQ_REWIND: u32 = 1048576;
...
pub const IORING_TIMEOUT_IMMEDIATE_ARG: u32 = 128;
...
ZCRX_FEATURE_NOTIFICATION = 2,
}
#[repr(u8)]
#[non_exhaustive]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum zcrx_notification_type {
ZCRX_NOTIF_NO_BUFFERS = 0,
ZCRX_NOTIF_COPY = 1,
__ZCRX_NOTIF_TYPE_LAST = 2,
}
#[repr(u8)]
#[non_exhaustive]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum zcrx_notification_desc_flags {
ZCRX_NOTIF_DESC_FLAG_STATS = 1,
}
#[repr(u8)]
#[non_exhaustive]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
pub zc_arm_notif: zcrx_ctrl_arm_notif,
}
#[repr(C)]
#[derive(Copy, Clone)]
